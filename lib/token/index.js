          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                sequence = _args2.length > 5 && _args2[5] !== undefined ? _args2[5] : null;
              ...
              case 11:
                ...
                _context2.next = 17;
                return this._bncClient._prepareTransaction(issueMsg, signIssueMsg, senderAddress, sequence);
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                sequence = _args3.length > 3 && _args3[3] !== undefined ? _args3[3] : null;
                ...
                _context3.next = 9;
                return this._bncClient._prepareTransaction(freezeMsg, freezeSignMsg, fromAddress, sequence);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 9;
                return this._bncClient._prepareTransaction(unfreezeMsg, unfreezeSignMsg, fromAddress, sequence);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 9;
                return this._bncClient._prepareTransaction(burnMsg, burnSignMsg, fromAddress, sequence);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 4:
                ...
                _context6.next = 10;
                return this._bncClient._prepareTransaction(mintMsg, mintSignMsg, fromAddress, sequence);
