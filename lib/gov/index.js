        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                sequence = _args.length > 1 && _args[1] !== undefined ? _args[1] : null;
                listTradingPairObj = {
                ...
                _context.next = 6;
                return this.submitProposal(address, title, description, _proposalType["default"].ProposalTypeListTradingPair, initialDeposit, votingPeriod, sequence);
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                sequence = _args2.length > 6 && _args2[6] !== undefined ? _args2[6] : null;
                ...
                _context2.next = 8;
                return this._bncClient._prepareTransaction(proposalMsg, signMsg, address, sequence);
